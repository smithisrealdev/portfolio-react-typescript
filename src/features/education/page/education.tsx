...
import University from '../../../assets/images/education-img.png'
import FirebaseImg from '../../../assets/images/firebase-img.png'
import PlusIcon from '../../../assets/images/plus-icon.png'
import ArduinoIcon from '../../../assets/images/arduino-icon.webp'
    ...
    return (
        <Container maxWidth="xl" className="bg-main pl-20 h-full">
            <Title noUseLeave={false} noUseEnter={true} text={FormatMessage('education.title')} />
                <Text text='History' className='text-white text-xl font-semibold pb-4 pl-8' />
            <div className='flex'>
            ...
            <div className='mt-16 pl-8 pb-8 '>
                <Grid item xs={1}>
                    <Text text='Graduate Project' className='text-white text-xl font-semibold pb-4' />
